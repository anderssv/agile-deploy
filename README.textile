...
You can find the slides (Norwegian only) here:
http://www.slideshare.net/anderssv/javazone2009-smidig-utrulling
...
<pre>repo.url=http://myrepo.myorg.com/maven2/</pre>
...
* Option for disabling execution of DB scripts
